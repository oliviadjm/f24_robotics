...
def generate_launch_description():
    package_dir = get_package_share_directory('final_project')
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            ...
            description='Choose one of the world files from `/final_project/worlds` directory'
        ),
        DeclareLaunchArgument(
            'mode',
